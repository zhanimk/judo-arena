...
function ResetPassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setError("");
    if (password !== confirm) { setError("Құпиясөздер сәйкес келмейді"); return; }
    if (!token)               { setError("Сілтеме жарамсыз"); return; }
    setLoading(true);
    try {
      ...
      <div className="w-full max-w-sm">
        ...
        {!token ? (
          ...
          <div className="rounded-2xl bg-white/4 border border-white/8 p-8 text-center">
            ...
            <h2 className="font-display text-2xl font-bold mb-2">Сілтеме жарамсыз</h2>
            <p className="text-white/50 text-sm leading-relaxed mb-6">
              Бұл сілтеме ескірген немесе қате. Жаңасын алыңыз.
            </p>
            <Link
              to="/forgot-password"
          ...
          <div className="rounded-2xl bg-white/4 border border-white/8 p-8 text-center">
            ...
            <h2 className="font-display text-2xl font-bold mb-2">Сәтті өзгертілді</h2>
            <p className="text-white/50 text-sm leading-relaxed">
              Жаңа құпиясөз сақталды. Кіру бетіне бағытталуда…
            </p>
          ...
          <>
            ...
            <h1 className="font-display text-2xl font-bold mb-1.5">Жаңа құпиясөз</h1>
            <p className="text-white/45 text-sm mb-8">
              Аккаунтыңыз үшін сенімді жаңа құпиясөз орнатыңыз.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              ...
              <p className="text-[11px] text-white/30">Кемінде 8 таңба</p>
