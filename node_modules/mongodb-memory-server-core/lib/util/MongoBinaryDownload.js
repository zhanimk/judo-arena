...
class MongoBinaryDownload {
    ...
    async attemptDownload(url, useHttpsOptions, downloadLocation, tempDownloadLocation, downloadUrl, httpOptions, timeout = 60000) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const protocol = (0, resolveConfig_1.envToBool)((0, resolveConfig_1.default)(resolveConfig_1.ResolveConfigVariables.USE_HTTP)) ? follow_redirects_1.http : follow_redirects_1.https;
