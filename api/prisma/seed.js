...
// УТИЛИТЫ
// ============================================================
function randomBirthDate(ageMin = 18, ageMax = 30) {
...
async function main() {
    ...
    for (let clubIdx = 0; clubIdx < CLUBS.length; clubIdx++) {
        ...
        clubs.push(club);
        console.log(`✓ Клуб «${c.name.kk}» (${c.city}): тренер + 8 спортсменов`);
    }
    // ---- 4. ТУРНИР + КАТЕГОРИИ ----
    ...
    console.log(`✓ Турнир: «${TOURNAMENT.name.kk}» (статус REGISTRATION_OPEN)`);
    for (let i = 0; i < CATEGORIES.length; i++) {
        ...
        console.log(`  ✓ Категория: ${cat.name.kk} [${cat.format}]`);
    }
