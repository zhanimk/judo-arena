...
const tournamentsContent = fs.readFileSync(
  "web/src/routes/coach.tournaments.tsx",
  "utf8",
);
const applicationsContent = fs.readFileSync(
  "web/src/routes/coach.applications.tsx",
  "utf8",
);

// I'll manually construct the combined file to ensure it's correct.

const newContent = `import { RouteErrorUI } from "@/components/ui/ErrorBoundary";
                      ...
                      <div className="mt-4 flex flex-wrap justify-between items-center gap-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          {existingApp ? (
                            ...
                            >
                              <Link to="/coach/tournaments/$id" params={{ id: tournament.id }} className="flex items-center gap-1">
...
fs.writeFileSync("web/src/routes/coach.tournaments.tsx", newContent);
